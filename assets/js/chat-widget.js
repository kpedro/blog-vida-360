...
(function () {
    ...
    function injectN8nCustomStyles() {
        ...
        style.textContent = [
            ...
            '  .n8n-chat .chat-window, .chat-window {',
            '    width: calc(100vw - 12px) !important;',
            '    max-width: calc(100vw - 12px) !important;',
            '    right: 6px !important;',
            '  }',
            '  .blog360-chat-quick-grid { flex-direction: column !important; }',
            '  .blog360-chat-quick-grid button { width: 100% !important; white-space: normal !important; flex: 1 1 100% !important; margin-left: 0 !important; margin-right: 0 !important; min-width: 0 !important; }',
            '}',
            '',
